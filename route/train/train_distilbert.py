...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default="route/train/data/train_data_distilbert_4class.json", help="Directory containing training data")
    ...
    def _preprocess_data(examples):
        ...
        model_inputs["labels"] = examples["source_label"]
        return model_inputs
