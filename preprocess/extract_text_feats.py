...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_tokens", type=int, default=512, help="Maximum tokens per chunk when --long_text is enabled.")
    parser.add_argument("--batch_size", type=int, default=256, help="Batch size for text embedding.")
